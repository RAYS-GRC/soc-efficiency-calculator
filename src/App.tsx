        ...
        <div className="app-header">
          <div>
            ...
            <div className="app-subtitle">
              Based on SEBI CSCRF Annexure-N · Designed for security and GRC teams.
            </div>
            <div className="badge-row">
              ...
              <span className="small-pill">
                🤝 Open-source contribution by <strong>Rajesh Yalavaguli Seetharamarao</strong> to the GRC community.
              </span>
            </div>
          </div>
